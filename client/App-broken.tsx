        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route
              ...
              element={<ComprehensiveStorefront />}
            />
            <Route
              path="/store/:storeName/product/:productId"
              element={<PlaceholderPage type="store-product" />}
            />
            <Route
              path="/store/:storeName/category/:categoryId"
              element={<PlaceholderPage type="store-category" />}
            />
            <Route
              path="/store/:storeName/cart"
              element={<PlaceholderPage type="store-cart" />}
            />
            <Route
              path="/store/:storeName/checkout"
              element={<PlaceholderPage type="store-checkout" />}
            />
