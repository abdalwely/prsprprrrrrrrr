...
//         try {
//           const devResult = await signInUserDev(
//             formData.email,
//             formData.password,
//           );
//           result = {
...
//         const from =
//           location.state?.from?.pathname || `/${activeTab}/dashboard`;
...
//         errorMessage =
//           "فشل الاتصال بالشبكة. يرجى التحقق من الاتصال بالإنترنت والمحاولة مرة أخرى.";
//       } else if (error.code) {
//         switch (error.code) {
