...
export default function Index() {
  ...
  const text = {
    ar: {
      ...
      heroDescription:
        "أنشئ متجرك الإلكتروني الاحترافي في دقائق، مع إدارة شاملة للمنتجات والطلبات والمدفوعات والشحن. منصة واحدة تضم آلاف المتاجر مع تحكم كامل وخصوصية تامة لكل تاجر.",
      ...
      multiVendorDesc:
        "كل تاجر له متجر مستقل بالكامل مع إدارة منفصلة للمنتجات والعملاء والطلبات",

      smartDesign: "تصميم ذكي قابل للتخصيص",
      smartDesignDesc:
        "خصص متجرك بالكامل: الألوان، الخطوط، الشعار، والتخطيط دون معرفة برمجية",

      analytics: "تحليلات ذكية",
      analyticsDesc:
        "تقارير مفصلة عن المبيعات والعملاء والمنتجات مع رؤى تحليلية متقدمة",

      payments: "مدفوعات آمنة",
      paymentsDesc:
        "تكامل مع جميع بوابات الدفع المحلية والعالمية مع أعلى معايير الأمان",

      shipping: "شحن ذكي",
      shippingDesc:
        "إدارة الشحن مع شركاء الشحن المحليين والعالميين وتتبع الطلبات فوري",
      ...
      affiliateDesc:
        "نظام تسويق تابع شامل لزيادة المبيعات عبر المسوقين والشركاء",
      ...
      ctaDescription:
        "انضم إلى آلاف التجار الناجحين وا��صل على متجرك الاحترافي في دقائق",
    ...
    en: {
      ...
      heroDescription:
        "Create your professional online store in minutes with comprehensive management for products, orders, payments, and shipping. One platform hosting thousands of stores with complete control and privacy for each merchant.",
      ...
      featuresSubtitle:
        "Everything you need to successfully manage your e-commerce business",

      multiVendor: "Multi-Vendor",
      multiVendorDesc:
        "Each merchant has a completely independent store with separate management for products, customers, and orders",

      smartDesign: "Smart Customizable Design",
      smartDesignDesc:
        "Fully customize your store: colors, fonts, logo, and layout without programming knowledge",

      analytics: "Smart Analytics",
      analyticsDesc:
        "Detailed reports on sales, customers, and products with advanced analytical insights",

      payments: "Secure Payments",
      paymentsDesc:
        "Integration with all local and global payment gateways with highest security standards",

      shipping: "Smart Shipping",
      shippingDesc:
        "Shipping management with local and global shipping partners and real-time order tracking",

      loyalty: "Loyalty Program",
      loyaltyDesc:
        "Advanced rewards points system to increase customer loyalty and repeat purchases",

      affiliate: "Affiliate Marketing",
      affiliateDesc:
        "Comprehensive affiliate marketing system to increase sales through marketers and partners",

      mobile: "Mobile App",
      mobileDesc:
        "Professional mobile app for iOS and Android with seamless experience",
      ...
      ctaDescription:
        "Join thousands of successful merchants and get your professional store in minutes",
    ...
    >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Badge className="mb-6 bg-gradient-to-r from-primary to-brand text-white">
              ...
              {isArabic
                ? "الجيل الجديد من منصات التجارة الإلكترونية"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link to="/customer/stores">
                <Button
                  size="lg"
                  variant="outline"
                  className="text-lg px-8 py-6 bg-blue-50 hover:bg-blue-100 border-blue-200"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="card-shadow hover:shadow-xl transition-all duration-300 border-0 group"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <Card
                key={index}
                className={`card-shadow hover:shadow-xl transition-all duration-300 ${plan.popular ? "ring-2 ring-primary scale-105" : ""}`}
              >
                <CardHeader className="text-center">
                  {plan.popular && (
                ...
                <CardContent>
                  ...
                  <Button
                    className={`w-full ${plan.popular ? "btn-gradient" : "border-primary text-primary hover:bg-primary hover:text-white"}`}
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-brand text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold mb-4">{currentText.ctaTitle}</h2>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <p className="text-gray-400">
                {isArabic
                  ...
                  : "Leading e-commerce platform in the region"}
              </p>
            </div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <Link
                    ...
                    className="hover:text-white transition-colors"
                  >
                    {isArabic ? "الدليل التقني" : "Documentation"}
                  </Link>
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 {currentText.heroTitle}.{" "}
