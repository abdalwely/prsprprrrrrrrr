...
const EnhancedStoreFrontend: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <header
        className={`${
          customization?.layout?.headerStyle === "fixed"
            ? "fixed top-0 z-50"
            : ""
          ...
          <div className="container mx-auto flex justify-between items-center text-sm">
            ...
            <div className="flex items-center gap-3">
              {customization?.social?.platforms?.facebook && (
                <a
                  href={customization.social.platforms.facebook}
              ...
              {customization?.social?.platforms?.instagram && (
                <a
                  href={customization.social.platforms.instagram}
                  className="hover:opacity-80"
                >
              ...
              {customization?.social?.platforms?.twitter && (
                <a
                  href={customization.social.platforms.twitter}
                  className="hover:opacity-80"
                >
      ...
      {/* Hero Section */}
      {store.customization.enhancedHomepage?.heroSection && (
        <section className="relative py-20 bg-gradient-to-r from-[var(--brand-primary)] to-[var(--brand-secondary)] text-white">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-5xl font-bold mb-6">
              {
                store.customization.enhancedHomepage?.heroSection.content.title
                  .ar
              }
            </h1>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              {
                store.customization.enhancedHomepage?.heroSection.content
                  .subtitle.ar
              }
            </p>
            <Button
      ...
      <footer className="bg-gray-900 text-white pt-12 pb-6">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            {/* Newsletter */}
            {store.customization?.homepage?.newsletter?.enabled && (
              <div>
                <h4 className="text-lg font-semibold mb-4">
                  {store.customization.homepage.newsletter.title.ar}
                </h4>
                <p className="text-gray-400 mb-4">
                  {store.customization.homepage.newsletter.description.ar}
                </p>
                <div className="flex gap-2">
                  <Input
                    placeholder={
                      store.customization.homepage.newsletter.placeholder.ar
                    }
                    className="bg-gray-800 border-gray-700 text-white"
                  />
                  <Button className="bg-[var(--brand-primary)] hover:bg-[var(--brand-secondary)]">
                    {store.customization.homepage.newsletter.buttonText.ar}
                  </Button>
                </div>
              </div>
            )}
