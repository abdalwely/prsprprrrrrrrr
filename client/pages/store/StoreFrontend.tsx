  ...
  const loadStoreData = async () => {
    ...
    try {
      ...
      if (storeData) {
        ...
        // Load products
        const productsData = await productService.getByStore(
          storeData.id,
          "active",
        );
  ...
  return (
    <div
      ...
      style={{
        ...
        fontFamily:
          (store.customization.fonts as any)?.primary ||
          (store.customization as any)?.fonts?.primary ||
          "Cairo",
      }}
    >
      {/* Header */}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Search and Cart */}
            <div className="flex items-center space-x-4 rtl:space-x-reverse">
              {(store.customization?.layout as any)?.showSearch && (
              ...
              {(store.customization?.layout as any)?.showCart && (
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-white hover:bg-white/10"
      ...
      {(store.customization?.layout as any)?.showCategories && (
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-gray-600 mb-8">
              {store.description ||
                "اكتشف مجموعة رائعة من المنتجات عالية الجودة"}
            </p>
            <Button
              size="lg"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  اختيارنا المميز من أفضل المنتجات
                </p>
              </div>
            ...
            <div className="flex items-center space-x-4 rtl:space-x-reverse">
              ...
              <div className="flex border rounded-lg overflow-hidden">
                <Button
                  ...
                  style={{
                    backgroundColor:
                      viewMode === "grid" ? storeColors.primary : "transparent",
                ...
                <Button
                  ...
                  style={{
                    backgroundColor:
                      viewMode === "list" ? storeColors.primary : "transparent",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                {store.socialMedia?.whatsapp && (
                  <a
                    ...
                    className="flex items-center space-x-2 rtl:space-x-reverse p-3 bg-green-600 hover:bg-green-700 rounded-lg transition-colors"
                  >
                ...
                {store.socialMedia?.instagram && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-2 rtl:space-x-reverse p-3 bg-pink-600 hover:bg-pink-700 rounded-lg transition-colors"
                  >
                ...
                {store.socialMedia?.twitter && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-2 rtl:space-x-reverse p-3 bg-blue-400 hover:bg-blue-500 rounded-lg transition-colors"
                  >
                ...
                {store.socialMedia?.facebook && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-2 rtl:space-x-reverse p-3 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors"
                  >
                ...
                {store.socialMedia?.youtube && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-2 rtl:space-x-reverse p-3 bg-red-600 hover:bg-red-700 rounded-lg transition-colors"
                  >
                ...
                {store.socialMedia?.linkedin && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-2 rtl:space-x-reverse p-3 bg-blue-700 hover:bg-blue-800 rounded-lg transition-colors"
                  >
                ...
                {store.socialMedia?.snapchat && (
                  <a
                    href={`https://snapchat.com/add/${store.socialMedia.snapchat}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-2 rtl:space-x-reverse p-3 bg-yellow-400 hover:bg-yellow-500 rounded-lg transition-colors"
                  >
                    <span className="text-black">S</span>
                    <span className="text-black">سناب شات</span>
                  </a>
                )}

                {store.socialMedia?.tiktok && (
                  <a
                    href={`https://tiktok.com/@${store.socialMedia.tiktok}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-2 rtl:space-x-reverse p-3 bg-gray-800 hover:bg-gray-900 rounded-lg transition-colors"
                  >
              ...
              {/* رسالة في حالة عدم وجود وسائل تواصل */}
              {!store.socialMedia && (
                <div className="text-center py-4">
                  <p className="text-gray-400">
                    لا توجد وسائل تواصل اجتماعي متاحة حالياً
                  </p>
                </div>
              )}
            </div>
