    ...
    try {
      ...
      if (merchantStore) {
        ...
        const lowStockCount = storeProducts.filter(
          (product) => product.stock <= 5 && product.status === "active",
        ).length;
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                مرحباً {userData?.firstName}، إدر متجرك بكل سهولة
              </p>
            </div>
                    ...
                    {stats.lowStockProducts > 0 && (
                      <div className="flex items-center gap-3 p-3 bg-orange-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {stats.lowStockProducts} منتج بحاجة لإعادة تخزين
                          </p>
                        </div>
                      </div>
                    )}
                    {stats.pendingOrders > 0 && (
                      <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {stats.pendingOrders} طلب بحاجة لمتابعة
                          </p>
                        </div>
                      </div>
                    )}
