...
const fontOptions = [
  ...
  { name: "Amiri", value: "Amiri", preview: "Amiri - خط عربي تقليدي" },
  {
    ...
    preview: "Noto Sans Arabic - خط واضح",
  },
    ...
    try {
      ...
      if (updatedStore) {
        ...
        toast({
          ...
          description:
            "تم تطبيق التغييرات على متجرك. قم بتحديث صفحة المتجر لرؤية التغييرات.",
          action: (
            <Button
              onClick={() =>
                window.open(
                  `/store/${store.subdomain}?_t=${Date.now()}`,
                  "_blank",
                )
              }
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    `/store/${store.subdomain}?preview=true`,
                    "_blank",
                  )
                }
              >
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      ...
                      <Select
                        value={(
                          customization.layout?.productGridColumns || 4
                        ).toString()}
                        onValueChange={(value) =>
                          setCustomization((prev) => ({
                            ...prev,
                            layout: {
                              ...prev.layout,
                              productGridColumns: parseInt(value),
                            },
                          }))
                        }
                      >
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            id="hero"
                            checked={
                              customization.homepage?.showHeroSlider || true
                            }
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            id="categories"
                            checked={
                              customization.homepage?.showCategories || true
                            }
                            onCheckedChange={(checked) =>
                              setCustomization((prev) => ({
                                ...prev,
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            id="featured"
                            checked={
                              customization.homepage?.showFeaturedProducts ||
                              true
                            }
                            onCheckedChange={(checked) =>
                              setCustomization((prev) => ({
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            id="newsletter"
                            checked={
                              customization.homepage?.showNewsletter || true
                            }
                            onCheckedChange={(checked) =>
                              setCustomization((prev) => ({
                                ...prev,
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            id="wishlist"
                            checked={
                              customization.pages?.enableWishlist || true
                            }
                            onCheckedChange={(checked) =>
                              setCustomization((prev) => ({
                                ...prev,
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            id="compare"
                            checked={
                              customization.pages?.enableCompare || false
                            }
                            onCheckedChange={(checked) =>
                              setCustomization((prev) => ({
                                ...prev,
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            id="contact"
                            checked={
                              customization.pages?.enableContactUs || true
                            }
                            onCheckedChange={(checked) =>
                              setCustomization((prev) => ({
                                ...prev,
