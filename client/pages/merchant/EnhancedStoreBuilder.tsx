...
// // إنشاء كائن تهيئة افتراضي كامل
// // استبدل كامل كائن defaultCustomization بهذا:
...
//   // الخصائص المحسنة - مع إضافة الخصائص المفقودة
//   branding: {
//     logo: "",
//     favicon: "",
//     brandName: "",
...
//     useState<EnhancedStoreTemplate | null>(null);
...
//       id: 1,
//       title: "اختيار القالب",
//       description: "اختر القالب المناسب لمتجرك",
//     },
//     {
//       id: 2,
//       title: "معلومات المتجر",
//       description: "أدخل معلومات متجرك الأساسية",
//     },
//     { id: 3, title: "تخصيص التصميم", description: "خصص ألوان وخطوط متجرك" },
//     { id: 4, title: "إعدادات الصفحات", description: "اختر الصفحات والمكونات" },
//     {
//       id: 5,
//       title: "المعاينة والحفظ",
//       description: "راجع متجرك واحفظ الإعدادات",
//     },
//   ];
...
//             logo: store.logo || "",
//             customization: store.customization || defaultCustomization,
//           });

//           const template = enhancedStoreTemplates.find(
//             (t) => t.id === store.template,
//           );
//           if (template) {
...
//         ownerId: user.uid,
//         status: "active" as const, // ✅ إضافة as const
//         contact: {
//           email: user.email || "",
//           phone: user.phoneNumber || "",
//           address: "", // ✅ يجب أن يكون string
//           city: "", // ✅ إضافة city المطلوبة
//         },
//         settings: {
//           currency: "SAR",
//           language: "ar",
...
//             shippingCost: 0,
//             defaultCost: 0, // ✅ إضافة إذا كانت مطلوبة
//             zones: [], // ✅ إضافة إذا كانت مطلوبة
//           },
//           payment: {
//             cashOnDelivery: true,
//             bankTransfer: false,
//             creditCard: false,
//             paypal: false, // ✅ إضافة إذا كانت مطلوبة
//             stripe: false, // ✅ إضافة إذا كانت مطلوبة
//           },
//           taxes: {
//             enabled: false,
//             rate: 0,
...
//             pushNotifications: false, // ✅ إضافة إذا كانت مطلوبة
//           },
//         },
//       };
...
//           onValueChange={(value) =>
//             setStoreData((prev) => ({ ...prev, industry: value }))
//           }
//         >
...
//               onChange={(e) =>
//                 handleStoreInfoChange("subdomain", e.target.value)
//               }
...
//             {Object.entries(
//               storeData.customization?.branding?.brandColors || {},
//             ).map(([key, value]) => (
//               <div key={key}>
...
//               <Select
//                 value={
//                   storeData.customization?.typography?.primaryFont || "Cairo"
//                 }
//                 onValueChange={(value) =>
//                   handleCustomizationChange("typography", "primaryFont", value)
//                 }
//               >
...
//               <Select
//                 value={
//                   storeData.customization?.typography?.secondaryFont || "Inter"
//                 }
//                 onValueChange={(value) =>
...
//                 onValueChange={(value) =>
//                   handleCustomizationChange("layout", "headerStyle", value)
//                 }
//                 className="mt-2"
//               >
...
//               <RadioGroup
//                 value={
//                   storeData.customization?.layout?.footerStyle || "detailed"
//                 }
//                 onValueChange={(value) =>
//                   handleCustomizationChange("layout", "footerStyle", value)
//                 }
//                 className="mt-2"
//               >
//                 <div className="flex items-center space-x-2">
...
//             <CardDescription>
//               اختر الصفحات التي تريد إظهارها في متجرك
//             </CardDescription>
//           </CardHeader>
//           <CardContent className="space-y-4">
//             {Object.entries(storeData.customization?.staticPages || {}).map(
//               ([key, page]) => (
...
//                       handleCustomizationChange("staticPages", key, {
//                         ...page,
//                         enabled: checked,
//                       })
//                     }
...
//           <CardContent className="space-y-4">
//             {Object.entries(
//               storeData.customization?.enhancedHomepage || {},
//             ).map(
//               ([key, component]) =>
//                 key !== "banners" &&
...
//                       onCheckedChange={(checked) =>
//                         handleCustomizationChange("enhancedHomepage", key, {
//                           ...component,
//                           enabled: checked,
//                         })
//                       }
...
//               </Label>
//               <p className="text-sm">
//                 {storeData.subdomain || "غير محدد"}.platform.com
//               </p>
//             </div>
//             <div>
//               <Label className="text-sm font-medium text-gray-600">
...
//               </Label>
//               <p className="text-sm">
//                 {selectedTemplate?.name.ar || "غير محدد"}
//               </p>
//             </div>
//             <div>
//               <Label className="text-sm font-medium text-gray-600">
...
//               </Label>
//               <p className="text-sm">
//                 {industries.find((i) => i.value === storeData.industry)?.label
//                   .ar || "عام"}
//               </p>
//             </div>
//           </div>
