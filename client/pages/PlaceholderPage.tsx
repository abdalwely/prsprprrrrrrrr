...
export default function PlaceholderPage({ type }: PlaceholderPageProps) {
  ...
  > = {
    ...
    features: {
      ...
      description: {
        ar: "اكتشف جميع مميزات منصة التجارة الذكية",
        en: "Discover all Smart Commerce Platform features",
      },
      icon: Star,
    ...
    about: {
      ...
      description: {
        ar: "تعرف على قصة منصة التجارة الذكية",
        en: "Learn about Smart Commerce Platform story",
      },
      icon: Users,
    ...
    docs: {
      ...
      description: {
        ar: "دليل المطورين والتقنيين",
        en: "Developer and technical guide",
      },
      icon: BookOpen,
    ...
    "merchant-dashboard": {
      ...
      description: {
        ar: "إدارة متجرك ومنتجاتك",
        en: "Manage your store and products",
      },
      icon: Store,
      color: "from-blue-500 to-purple-600",
      category: "merchant",
    ...
    "merchant-products": {
      ...
      description: {
        ar: "أضف وعدّل منتجاتك",
        en: "Add and edit your products",
      },
      icon: Package,
      color: "from-green-500 to-teal-600",
      category: "merchant",
    ...
    "merchant-orders": {
      ...
      description: {
        ar: "تتبع وإدارة طلبات العملاء",
        en: "Track and manage customer orders",
      },
      icon: ShoppingCart,
      color: "from-orange-500 to-red-600",
      category: "merchant",
    ...
    "merchant-customers": {
      ...
      description: {
        ar: "تفاعل مع عملائك",
        en: "Interact with your customers",
      },
      icon: Users,
      color: "from-purple-500 to-pink-600",
      category: "merchant",
    ...
    "merchant-analytics": {
      ...
      description: {
        ar: "تحليل أداء متجرك",
        en: "Analyze your store performance",
      },
      icon: BarChart3,
      color: "from-indigo-500 to-blue-600",
      category: "merchant",
    ...
    "merchant-payments": {
      ...
      description: {
        ar: "تتبع إيراداتك والمدفوعات",
        en: "Track your revenue and payments",
      },
      icon: CreditCard,
      color: "from-emerald-500 to-green-600",
      category: "merchant",
    ...
    "merchant-shipping": {
      ...
      description: {
        ar: "إعداد خيارات الشحن",
        en: "Configure shipping options",
      },
      icon: Truck,
    ...
    "merchant-settings": {
      ...
      description: {
        ar: "تخصيص إعدادات متجرك",
        en: "Customize your store settings",
      },
      icon: Settings,
      color: "from-gray-500 to-gray-600",
      category: "merchant",
    ...
    "customer-dashboard": {
      ...
      description: {
        ar: "تتبع طلباتك ومشترياتك",
        en: "Track your orders and purchases",
      },
      icon: ShoppingBag,
      color: "from-green-500 to-teal-600",
      category: "customer",
    ...
    "customer-addresses": {
      ...
      description: {
        ar: "إدارة عناوين الشحن",
        en: "Manage shipping addresses",
      },
      icon: MapPin,
      color: "from-orange-500 to-red-600",
      category: "customer",
    ...
    "customer-loyalty": {
      ...
      description: {
        ar: "نقاط المكافآت والعروض",
        en: "Reward points and offers",
      },
      icon: Star,
      color: "from-yellow-500 to-orange-600",
      category: "customer",
    ...
    "admin-dashboard": {
      ...
      description: {
        ar: "إدارة المنصة والنظام",
        en: "Manage platform and system",
      },
      icon: Shield,
      color: "from-red-500 to-pink-600",
      category: "admin",
    ...
    "admin-merchants": {
      ...
      description: {
        ar: "إدارة حسابات التجار",
        en: "Manage merchant accounts",
      },
      icon: Store,
      color: "from-blue-500 to-purple-600",
      category: "admin",
    ...
    "admin-customers": {
      title: { ar: "إدارة العملاء", en: "Customer Management" },
      description: {
        ar: "إدارة حسابات العملاء",
        en: "Manage customer accounts",
      },
      icon: Users,
      color: "from-green-500 to-teal-600",
      category: "admin",
    ...
    "admin-stores": {
      ...
      description: {
        ar: "مراقبة وإدارة المتاجر",
        en: "Monitor and manage stores",
      },
      icon: Store,
      color: "from-purple-500 to-pink-600",
      category: "admin",
    ...
    "admin-analytics": {
      ...
      description: {
        ar: "تحليل أداء المنصة العام",
        en: "Analyze overall platform performance",
      },
      icon: BarChart3,
      color: "from-indigo-500 to-blue-600",
      category: "admin",
    ...
    "admin-payments": {
      title: { ar: "إدارة المدفوعات", en: "Payment Management" },
      description: {
        ar: "مراقبة المعاملات المالية",
        en: "Monitor financial transactions",
      },
      icon: CreditCard,
      color: "from-emerald-500 to-green-600",
      category: "admin",
    ...
    "admin-settings": {
      ...
      description: {
        ar: "إد��رة إعدادات المنصة",
        en: "Manage platform settings",
      },
      icon: Settings,
      color: "from-gray-500 to-gray-600",
      category: "admin",
    ...
    "admin-reports": {
      ...
      description: {
        ar: "تقارير مفصلة عن النشاط",
        en: "Detailed activity reports",
      },
      icon: FileText,
      color: "from-teal-500 to-cyan-600",
      category: "admin",
    ...
    "store-cart": {
      ...
      description: {
        ar: "مراجعة المنتجات المختارة",
        en: "Review selected products",
      },
      icon: ShoppingCart,
      color: "from-orange-500 to-red-600",
      category: "store",
    ...
    marketplace: {
      ...
      description: {
        ar: "تصفح جميع المتاجر والمنتجات",
        en: "Browse all stores and products",
      },
      icon: Store,
      color: "from-indigo-500 to-blue-600",
      category: "public",
  ...
  const config = pageConfigs[type] || {
    ...
    description: {
      ar: "هذه الصفحة غير متوفرة حالياً",
        ...
        <div className="relative w-full max-w-2xl">
          <Card className="card-shadow">
            <CardHeader className="text-center pb-8">
              <div
                className={`w-24 h-24 mx-auto rounded-full bg-gradient-to-r ${config.color} flex items-center justify-center mb-6`}
              >
              ...
              <p className="text-gray-500">{currentText.inDevelopment}</p>
            </CardHeader>

            <CardContent className="space-y-6">
              {"features" in config && config.features && (
                <div>
