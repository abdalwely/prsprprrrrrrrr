...
const EnhancedAdminDashboard: React.FC = () => {
  ...
  const handleRejectApplication = async (application: StoreApplication) => {
    ...
    try {
      const success = await rejectStoreApplication(
        application.id,
        "admin_user",
        rejectionReason,
      );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            إدارة طلبات إنشاء المتاجر والموافقة عليها
          </p>
        </div>
          ...
          <CardHeader>
            <div className="flex justify-between items-center">
              <div>
                ...
                <CardDescription>
                  راجع واتخذ قرار بشأن طلبات إنشاء المتاجر الجديدة
                </CardDescription>
              </div>
              ...
              {stats.pending > 0 && (
                <Alert className="w-auto border-orange-200 bg-orange-50">
                  ...
                  <AlertDescription className="text-orange-800">
                    يوجد {stats.pending} طلب في انتظار المراجعة
                  </AlertDescription>
                </Alert>
              )}
            </div>
                          ...
                          <DialogContent className="max-w-4xl" dir="rtl">
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                مراجعة تفاصيل طلب{" "}
                                {
                                  application.storeConfig.customization
                                    .storeName
                                }
                              </DialogDescription>
                            </DialogHeader>
                                ...
                                <div className="flex gap-3 pt-4 border-t">
                                  ...
                                  <Dialog>
                                    ...
                                    <DialogContent dir="rtl">
                                      <DialogHeader>
                                        <DialogTitle>
                                          رفض طلب إنشاء المتجر
                                        </DialogTitle>
                                        <DialogDescription>
                                          يرجى إدخال سبب رفض الطلب لإرساله
                                          للتاجر
                                        </DialogDescription>
                                      </DialogHeader>
                                      <div className="space-y-4">
              ...
              {filteredApplications.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">
                    {filter === "all"
                      ? "لا توجد طلبات إنشاء متاجر حالياً"
                      : filter === "pending"
