...
export class ProductService {
  ...
  /**
   * 🔧 دالة مساعدة لاستخراج أنشطة المتجر
   */
  ...
  /**
   * 🏷️ دالة للحصول على تسمية النشاط
   */
      ...
      for (const doc of querySnapshot.docs) {
        try {
          ...
          if (product._semantics?.detectedActivity === "agriculture") {
            ...
            // 🔥 إذا كان متوافقاً ولكن الحالة non_compliant
            if (
              isCompatible &&
   ...
   */
  /**
   * دالة مساعدة: التحقق إذا كان المتجر زراعي - محسّنة
   */
